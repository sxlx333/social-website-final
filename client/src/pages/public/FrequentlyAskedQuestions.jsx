        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className={styles.faqCard}>
              <p className={styles.faqQuestion}>Kaip sukurti naują įrašą?</p>
              <p className={styles.faqAnswer}>
                ...
                <ol className={styles.faqList}>
                  ...
                  <li className={styles.faqListItem}>
                    Eikite į pagrindinį puslapį arba spustelėkite mygtuką
                    „Sukurti įrašą“.
                  </li>
                  <li className={styles.faqListItem}>
                    Užpildykite įrašo laukelį tekstu, nuotraukomis ar kita
                    medija.
                  </li>
                  <li className={styles.faqListItem}>
